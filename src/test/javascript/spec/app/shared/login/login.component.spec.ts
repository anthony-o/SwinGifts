...
describe('Component Tests', () => {
  describe('LoginComponent', () => {
    let comp: SwgLoginModalComponent;
    let fixture: ComponentFixture<SwgLoginModalComponent>;
    ...
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [SwgLoginModalComponent],
        providers: [
          FormBuilder,
          {
        ...
        .overrideTemplate(SwgLoginModalComponent, '')
        .compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(SwgLoginModalComponent);
