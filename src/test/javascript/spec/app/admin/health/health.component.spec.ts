...
import { SwgHealthCheckComponent } from 'app/admin/health/health.component';
import { SwgHealthService } from 'app/admin/health/health.service';

describe('Component Tests', () => {
  describe('SwgHealthCheckComponent', () => {
    let comp: SwgHealthCheckComponent;
    let fixture: ComponentFixture<SwgHealthCheckComponent>;
    let service: SwgHealthService;

    beforeEach(async(() => {
      TestBed.configureTestingModule({
        imports: [SwinGiftsTestModule],
        declarations: [SwgHealthCheckComponent]
      })
        .overrideTemplate(SwgHealthCheckComponent, '')
        .compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(SwgHealthCheckComponent);
      comp = fixture.componentInstance;
      service = fixture.debugElement.injector.get(SwgHealthService);
    });
