package com.github.anthonyo.swingifts.config.timezone;

import com.github.anthonyo.swingifts.SwinGiftsApp;
import com.github.anthonyo.swingifts.repository.timezone.DateTimeWrapper;
import com.github.anthonyo.swingifts.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM swg_date_time_wrapper where id=%d", fieldName, id);
    }
